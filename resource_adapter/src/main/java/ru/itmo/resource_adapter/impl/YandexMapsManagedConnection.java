...
public class YandexMapsManagedConnection implements ManagedConnection {
    ...
    private final YandexMapsManagedConnectionFactory mcf;
    private PrintWriter logWriter;
    private final List<ConnectionEventListener> listeners = new ArrayList<>();
    private YandexMapsConnectionImpl connectionHandle;
    ...
    public Object getConnection(javax.security.auth.Subject subject, ConnectionRequestInfo cxRequestInfo) throws ResourceException {
        connectionHandle = new YandexMapsConnectionImpl(this);
    ...
    void closeHandle(YandexMapsConnectionImpl handle) {
    ...
    public void associateConnection(Object connection) throws ResourceException {
        ...
        this.connectionHandle = (YandexMapsConnectionImpl) connection;
    }
    ...
    public boolean equals(Object o) {
        ...
        YandexMapsManagedConnection that = (YandexMapsManagedConnection) o;
